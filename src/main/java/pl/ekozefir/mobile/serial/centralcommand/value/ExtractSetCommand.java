 ...
 */
public class ExtractSetCommand implements MobileCommand {

    private static final int type = 0x03;
    private final int value;

    public ExtractSetCommand(int value) {
        this.value = value;
    }

    @Override
    public byte[] createCommand() {
        return MessageBuilder.setType(type).appendFirstParameter(value).build();
    }
