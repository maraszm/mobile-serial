 ...
 */
public class TempAdditionalParser implements MobileParser<Temperature>{

    private static final int highByteNumber = 22;
    private static final int lowByteNumber = 21;
