 ...
 */
public class TempControllerParser implements MobileParser<Temperature> {

    private static final int highByteNumber = 18;
    private static final int lowByteNumber = 17;
